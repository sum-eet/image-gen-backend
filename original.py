...
#     text = str(question)
font = 'Inter.ttf'
img = ImageText((1200, 600), background=(255, 255, 255, 200))  # 200 = alpha
...
img.fill_text_box((100, 100), text, box_width=1000, box_height=200,
                  font_filename=font)
...
#     text = str(question)
font = 'Inter.ttf'
img = ImageText((1200, 800), background=(255, 255, 255, 200))  # 200 = alpha
